...
var baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?ordering=${sortAscDesc}&limit=20`;
...
function Scores(props) {
  ...
  const searchValidation = () => {
    ...
    if (localStorage.getItem("yearSelect").length === 4 && localStorage.getItem("scoreSelect") && localStorage.getItem("colorSelect")) {
      baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?limit=20&ordering=${localStorage.getItem("scoreSelect")}&limit=20&vintage=${localStorage.getItem("yearSelect")}&color=${localStorage.getItem("colorSelect")}`;
    ...
    if (localStorage.getItem("yearSelect").length === 4 && localStorage.getItem("scoreSelect") && !localStorage.getItem("colorSelect")) {
      baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?limit=20&ordering=${localStorage.getItem("scoreSelect")}&limit=20&vintage=${localStorage.getItem("yearSelect")}`;
      console.log("year and score");
      console.log(baseUrl);
      filterSearch();
    }
    if (localStorage.getItem("yearSelect").length === 4 && !localStorage.getItem("scoreSelect") && localStorage.getItem("colorSelect")) {
      baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?limit=20&color=${localStorage.getItem("colorSelect")}&limit=20&vintage=${localStorage.getItem("yearSelect")}`;
      console.log("year and color");
      console.log(baseUrl);
      filterSearch();
    }
    if (localStorage.getItem("yearSelect").length === 4 && !localStorage.getItem("scoreSelect") && !localStorage.getItem("colorSelect")) {
      baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?limit=20&vintage=${localStorage.getItem("yearSelect")}`;
    ...
    if (
      ...
      baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?limit=20&ordering=${localStorage.getItem("scoreSelect")}`;
    ...
    if (
      ...
      baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?limit=20&ordering=${localStorage.getItem("scoreSelect")}&color=${localStorage.getItem("colorSelect")}`;
    ...
    if (
      ...
      baseUrl = `https://cors-anywhere.herokuapp.com/https://api.globalwinescore.com/globalwinescores/latest/?limit=20&color=${localStorage.getItem("colorSelect")}`;
